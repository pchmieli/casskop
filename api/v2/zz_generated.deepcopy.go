...
func (in *CassandraClusterStatus) DeepCopyInto(out *CassandraClusterStatus) {
	*out = *in
	in.CassandraPhase.DeepCopyInto(&out.CassandraPhase)
	if in.SeedList != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CassandraPhase) DeepCopyInto(out *CassandraPhase) {
	*out = *in
	if in.InitializingSubPhase != nil {
		in, out := &in.InitializingSubPhase, &out.InitializingSubPhase
		*out = new(InitializingSubPhase)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CassandraPhase.
func (in *CassandraPhase) DeepCopy() *CassandraPhase {
	if in == nil {
		return nil
	}
	out := new(CassandraPhase)
	in.DeepCopyInto(out)
	return out
}
